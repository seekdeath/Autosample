...
extern u8  rotateWorkFlag ;
extern u8  subWorkFlag ;

extern u8  move1Flag ;
extern u8  move2Flag ;
//extern u8  move3Flag ;
extern u8  rotateFlag ;
...
#define MOTOR_ADDSAMPLE_ADDR		    'D'	        //2
#define MOTOR_MOVESAMPLE1_ADDR	        'B'	        //4
#define MOTOR_MOVESAMPLE2_ADDR          'C'             //5
#define MOTOR_ROTATESAMPLE_ADDR         'E'             //7
#define MOTOR_SUBSAMPLE_ADDR            'A'             //8				
...
extern MotorGL  motorAddS,motorMoveS1,motorRotateS,motorSubS,motorMoveS2;
void MotorInit(void);
