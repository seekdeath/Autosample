...
#define   Add_Idle                     0x00    //组件空闲
#define   Add_Busy                     0x01    //组件忙，此时不应再向组件发送控制指令
#define   Add_Err_Transmition          0x80    //电机通信错误
#define   Add_Err_Origin               0x81    //原点传感器失效
...
#define   Rotate_Idle                    0x00    //组件空闲
#define   Rotate_Busy                    0x01    //组件忙，此时不应再向组件发送控制指令
#define   Rotate_Err_Transmition         0x80    //电机通信错误
#define   Rotate_Err_Origin              0x81    //原点传感器失效
...
u8 Get_Add_State(void);
void Set_Add_State(u8 State);
...
u8 Get_Rotate_State(void);
void Set_Rotate_State(u8 State);
